...
area a b c 
  ...
  | otherwise = 0.0  -- Si no es un triángulo, el área es igual a 0
  where
...
listaEstudiantes = [
    Estudiante "Anahi" "Lorenzo" 20 "20739258",
    Estudiante "Perla" "Cruz" 23 "23385928",
    Estudiante "Yael" "Caballero" 21 "21892947",
    Estudiante "Santana" "Toral" 24 "24527499",
    Estudiante "Alejandro" "Canseco" 22 "22638512",
    Estudiante "Max" "Hernandez" 29 "29773950",
    Estudiante "Manuel" "Aragon" 20 "20375294",
    Estudiante "Bryan" "Barragan" 19 "19847295",
    Estudiante "Enrique" "Sandoval" 27 "27355291",
    Estudiante "Alberto" "Luna" 21 "21842519"
    ]
